    ...
    while True: # Mientras la condicion sea verdadera se va a repetir
        try: # Intentar hacer
            ...
            for mes in range(1, numero_meses + 1): #Por cada mes que este en el rango de {numero de meses} mas 1 ? Porque mas uno
                ...
                interes = (capital_anterior * tasa_interes_anual) / 12 # El interes va a ser igual a el {Capital anterior} por {La tasa de el interes anual} y todo eso vamos a dividirlo entre 2 
